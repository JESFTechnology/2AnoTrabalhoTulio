...
-- Copiando estrutura para tabela jesftech.db.avisos
CREATE TABLE IF NOT EXISTS `avisos` (
  `codAviso` int(11) NOT NULL AUTO_INCREMENT,
...
-- Copiando dados para a tabela jesftech.db.avisos: ~2 rows (aproximadamente)
INSERT INTO `avisos` (`codAviso`, `local`, `aviso`, `data`, `status`) VALUES
	(3, 'Arduino Uno Wifi', 'O produto Arduino Uno Wifi está com estoque baixo', '2022-11-30', 'Em andamento'),
	(4, 'ESP8266 ESP-01', 'O produto ESP8266 ESP-01 está com estoque baixo', '2022-11-30', 'Em andamento');

-- Copiando estrutura para tabela jesftech.db.chat
CREATE TABLE IF NOT EXISTS `chat` (
  `codChat` int(11) NOT NULL AUTO_INCREMENT,
  `mensagem` varchar(30) NOT NULL DEFAULT '',
  PRIMARY KEY (`codChat`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;

-- Copiando dados para a tabela jesftech.db.chat: ~0 rows (aproximadamente)
INSERT INTO `chat` (`codChat`, `mensagem`) VALUES
	(1, 'Johann: Bom dia funcionários'),
	(2, 'Johann: Hoje tivemos sucesso.');
...
-- Copiando estrutura para tabela jesftech.db.faturamento
CREATE TABLE IF NOT EXISTS `faturamento` (
  `codFaturamento` int(11) NOT NULL AUTO_INCREMENT,
  `dinheiro` double NOT NULL,
  `totalDeVendas` double NOT NULL,
  `codProduto` int(11) NOT NULL,
  `preco` double NOT NULL,
  PRIMARY KEY (`codFaturamento`),
  KEY `codProduto` (`codProduto`),
  CONSTRAINT `FK_faturamento_produtos` FOREIGN KEY (`codProduto`) REFERENCES `produtos` (`codProduto`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4;

-- Copiando dados para a tabela jesftech.db.faturamento: ~4 rows (aproximadamente)
INSERT INTO `faturamento` (`codFaturamento`, `dinheiro`, `totalDeVendas`, `codProduto`, `preco`) VALUES
	(1, 80, 8, 1, 10),
	(2, 0, 0, 2, 10),
	(3, 0, 0, 3, 10),
	(4, 0, 0, 34, 10);
...
INSERT INTO `funcionario` (`codFuncionario`, `nome`, `email`, `senha`, `cpf`, `cargo`, `nascimento`, `salario`, `codCidade`, `qrcode`, `bairro`, `endereco`) VALUES
	(1, 'Johann', 'johannsacconi@gmail.com', 'johann', '13642344674', 'Fundador', '2006-03-14', 10000, 9, '{Johann001johann}', 'Residencial Oliveira', 'Sabará 111'),
	(2, 'Luis', 'luisricardo@gmail.com', 'luis', '39258923854', 'Gerente', '2006-03-14', 5000, 8, '{Luis002luis}', 'Sla', 'Sla'),
	(3, 'Gustavo', 'gustavodias@gmail.com', 'gustavo', '29835629563', 'Motorista', '2006-03-14', 3000, 10, '{Gustavo003gustavo}', 'Sla', 'Sla'),
	(4, 'Pedro', 'pedromatos@gmail.com', 'pedro', '78345845780', 'Programador', '2003-09-10', 7000, 9, '{Pedro0014pedro}', 'Residencial Oliveira', 'Sla'),
	(5, 'Patrick', 'patrickboco@gmail.com', 'patrick', '34853874554', 'Gerente', '2004-10-19', 5000, 8, '{Patrick005patrick}', 'Sla', 'Sla'),
	(6, 'Rafael', 'rafaelcandido@gmail.com', 'rafael', '28375683756', 'Vendedor', '2004-10-19', 2000, 4, '{Rafael006rafael}', 'Sla', 'Sla'),
	(8, 'Bianca', 'biancacardoso@gmail.com', 'bianca', '18436534958', 'Designer', '2004-10-19', 3000, 9, '{Bianca008bianca}', 'Residencial Oliveira', 'Sla'),
	(9, 'Juliana', 'julianacassia@gmail.com', 'juliana', '38763459384', 'Pentester', '2004-10-19', 6000, 9, '{Juliana009juliana}', 'Residencial Oliveira', 'Sla'),
	(10, 'Jhenifer', 'jheniferbruschi@gmail.com', 'jhenifer', '13982743435', 'Designer', '2004-10-19', 3000, 12, '{Jhenifer0010jhenifer}', 'Sla', 'Sla'),
	(15, 'teste', 'teste@gmail.com', 'teste', '0', 'testador', '2001-01-01', 1000, 1, '{teste000teste}', 'testeville', 'teste 001');
...
-- Copiando dados para a tabela jesftech.db.itemvenda: ~11 rows (aproximadamente)
...
-- Copiando dados para a tabela jesftech.db.venda: ~6 rows (aproximadamente)
INSERT INTO `venda` (`codVenda`, `codCliente`, `statusDaVenda`, `dataVenda`, `codTransporte`) VALUES
	...
	(40, 7, 'Em andamento', '2023-06-12 12:47:56', 1);
...
-- Copiando estrutura para trigger jesftech.db.ZFaturamento
SET @OLDTMP_SQL_MODE=@@SQL_MODE, SQL_MODE='NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION';
DELIMITER //
CREATE TRIGGER `ZFaturamento` BEFORE UPDATE ON `faturamento` FOR EACH ROW BEGIN

UPDATE faturamento SET faturamento.dinheiro = faturamento.totalDeVendas * faturamento.preco WHERE faturamento.codFaturamento = NEW.codFaturamento;

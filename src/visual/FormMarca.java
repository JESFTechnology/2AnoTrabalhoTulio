...
public class FormMarca extends javax.swing.JDialog {
     ...
     */
    DAOGeral daoMarca = new DAOGeral();
    ...
    public void atualizarTabela(){
        listMarca.clear();
        listMarca.addAll(daoMarca.getListaMarca());
        int linha = listMarca.size()-1;
        if(linha>=0){
            tblMarcas.setRowSelectionInterval(linha, linha);
  tblMarcas.scrollRectToVisible(tblMarcas.getCellRect(linha,linha,true));
        }
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.swingbinding.JTableBinding jTableBinding = org.jdesktop.swingbinding.SwingBindings.createJTableBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, listMarca, tblMarcas);
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblMarcas, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.codigo}"), txtCodigo, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblMarcas, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.marca}"), txtCidade, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void btnProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximoActionPerformed
        ...
        if((linha+1)<=(tblMarcas.getRowCount()-1)){
            linha++;
        }
        tblMarcas.setRowSelectionInterval(linha, linha);
  tblMarcas.scrollRectToVisible(tblMarcas.getCellRect(linha, 0, true));
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        int linhaSelecionada = tblMarcas.getSelectedRow();
        Marca objMarca = listMarca.get(linhaSelecionada);
        daoMarca.removerMarca(objMarca);
        atualizarTabela();
        trataEdicao(false);
        }
  ...
  tblMarcas.scrollRectToVisible(tblMarcas.getCellRect(linha, 0, true));
    ...
    private void btnUltimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUltimoActionPerformed
        // TODO add your handling code here:
        int linha = tblMarcas.getRowCount()-1;
         tblMarcas.setRowSelectionInterval(linha, linha);
  tblMarcas.scrollRectToVisible(tblMarcas.getCellRect(linha, 0, true));
